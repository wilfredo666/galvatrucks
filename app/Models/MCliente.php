...
class MCliente extends Model
{
    ...
    protected $allowedFields = ['nombre_cli', 'apellido_cli', 'ci_nit_cli', 'fecha_nac_cli', 'estado_civil_cli', 'num_cuenta_cli', 'num_cuenta2_cli', 'razon_social_cli', 'direccion_cli', 'email_cli', 'contacto_cli', 'persona_contacto_cli', 'tipo_cli', 'imagen_cli', 'id_usuario','activo_cli'];
