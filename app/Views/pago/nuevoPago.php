                        ...
                        <div class="container col-md-12">
                            <div class="row">
                                <div class="form-group col-md-3 col-sm-10 ">
                                    ...
                                    <input type="text" class="form-control" id="nroBill" name="nroBill" placeholder="Ingrese NRO de BILL/BL" style="text-transform: uppercase;" list="listaBill" autocomplete="off">
