                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="clase" id="clase" class="form-control">
                            ...
                            <option value="OTROS" <?php if ($camion["clase"] == "OTROS") : ?> selected <?php endif; ?>>OTROS</option>
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="marca" id="marca" class="form-control">
                            ...
                            <option value="OTROS" <?php if ($camion["marca"] == "OTROS") : ?> selected <?php endif; ?>>OTROS</option>
                        </select>
                    </div>
                    <div class="form-group col-md-4">
