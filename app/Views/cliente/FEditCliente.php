            ...
            <div class="container">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <span class="text-danger chartjs-render-monitor" id="error-razonSocial"></span>
                    </div>
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <span class="text-danger chartjs-render-monitor" id="error-tipoCli"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <span class="text-danger chartjs-render-monitor" id="error-correoCli"></span>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <span class="text-danger chartjs-render-monitor" id="error-contactoCli"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-3">
                        <label>Cuenta Bancaria 1</label>
                        <input type="text" class="form-control" id="ctaCli" name="ctaCli" value="<?php echo $cliente["num_cuenta_cli"] ?>">
                    </div>
                    <div class="form-group col-md-3">
                        <label>Cuenta Bancaria 2</label>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label>ASIGNAR CREDENCIALES DE ACCESO</label>
                        <?php if ($cliente["id_usuario"] == 0) {
                        ?>
                            <select name="idUsuarioAcceso" id="idUsuarioAcceso" class="form-control">
                                <option value="">-- Seleccionar --</option>
                                <?php
                                foreach ($accesos as $usuAcceso) {
                                    $idUsu = $usuAcceso["id_usuario"];
                                    $nomUsu = $usuAcceso['nombre_usuario'];
                                ?>
                                    <option value="<?php echo $idUsu ?>"><?php echo $nomUsu ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        ?>
                            <select name="idUsuarioAcceso" id="idUsuarioAcceso" class="form-control" readonly>
                                <option value="<?php echo $cliente["id_usuario"] ?>">Credenciales Asignadas</option>
                            </select>
                        <?php
                        }
                        ?>
