      ...
      <div class="card-body login-card-body" style="border-radius: 20px; background-color:#a1a5b159;">
        ...
        <form action="<?php echo base_url(); ?>/Home/acceso" method="post">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-6">
              <button type="submit" class="btn btn-primary btn-block" style="border-radius: 10px; color: #fff;background-color: #04245f;border-color: #d0d6dc;box-shadow: none;">Iniciar Sesión</button>
            </div>
            <div class="col-3">
